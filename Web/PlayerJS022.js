...
function getDuration() {
    ...
    console.log(w);
    progress.style.backgroundImage = "-webkit-linear-gradient(left,#272727,#FF60AF " + w + "%, #FFECF5 " + w + "% ,	#FFECF5)";
...
function setVolume() {
    ...
    setVolValue.style.backgroundImage = "-webkit-linear-gradient(left,#272727,#9D9D9D " + setVolValue.value + "%, #ADADAD " + setVolValue.value + "% ,#E0E0E0)";
}
